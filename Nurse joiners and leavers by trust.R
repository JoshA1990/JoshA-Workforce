...
# Summary of joiner/ leavers by nationality at trust level
...
Raw_Data_y1 <- read_csv("Staff in Post - Workforce 201909 extracted Mar 21.csv")
...
#export to shared area with today's date
write.csv(long_format, paste("C:/Users/Josh.Andrews/OneDrive - Department of Health and Social Care/Nurse Data/Outputs/",str_replace_all(Sys.Date(),"-",""),"joiners_leavers_trust",long_format$Date_from[1],".csv"))
