...
Raw_Data_y2 <- read_csv("Staff in Post - Workforce 202306 extracted Aug 23.csv")
...
#export to shared area with today's date
#write.csv(long_format, paste("C:/Users/CSmith7/Data/Monthly Reporting/Midwife/",str_replace_all(Sys.Date(),"-",""),"joiners_leavers_dashboard",long_format$Date_from[1],".csv"))

#export to shared area with today's date
#write.csv(Reasonleaving, paste("C:/Users/CSmith7/Data/Monthly Reporting/Midwife/",str_replace_all(Sys.Date(),"-",""),"reason_for_leaving",long_format$Date_from[1],".csv"))

#export to shared area with today's date
#write.csv(Country, paste("C:/Users/CSmith7/Data/Monthly Reporting/Midwife/",str_replace_all(Sys.Date(),"-",""),"joiners_by_country",long_format$Date_from[1],".csv"))
